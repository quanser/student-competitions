...
### Projector
 ...
 ![visual representation of ride](../Pictures/ride_visual_representation_for_audience.png)
...
3. Flip the map over pulling parallel to the seam as shown here:
  ...
  ![flipping the roadmap over](../Pictures/flipping_roadmap_over.png)

Once the map is set up, the walls should be placed around the map as shown here:

  ![sdcs walls around the map](../Pictures/sdcs_walls_in_qlabs.png)
...
Here is one way of setting up the map :
  ...
  ![example setup of roadmap](../Pictures/example%20_roadmap_setup.png)