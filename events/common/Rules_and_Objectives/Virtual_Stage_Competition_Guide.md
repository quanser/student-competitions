...
Teams are provided with a [detailed scenario](../Rules_and_Objectives/Virtual_Detailed_Scenario.md) to guide their Self-Driving algorithms. This detailed scenario will serve as a good indicator whether a team's algorithm is ready, and it is encouraged that teams make the scenario more complex to fully showcase all aspects of their algorithm. The scenario can be made more complex by spawning in different actors within QLabs to create different traffic scenarios.
